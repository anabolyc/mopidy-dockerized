...
RUN  apt-get install -y cmake gstreamer1.0-pulseaudio gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gir1.2-gst-plugins-base-1.0 gir1.2-gstreamer-1.0 \
     ...
     pip install PyGObject Mopidy Mopidy-Mobile Mopidy-MusicBox-Webclient Mopidy-TuneIn Mopidy-MPD Mopidy-Bandcamp Mopidy-InternetArchive yt-dlp ytmusicapi Mopidy-YouTube Mopidy-SomaFM && \
