...
RUN  apt-get install -y gstreamer1.0-pulseaudio gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gir1.2-gst-plugins-base-1.0 gir1.2-gstreamer-1.0 \
     ...
     pip install PyGObject Mopidy Mopidy-Mobile Mopidy-TuneIn Mopidy-MPD Mopidy-RadioWorld Mopidy-Bandcamp Mopidy-InternetArchive youtube-dl ytmusicapi Mopidy-YouTube Mopidy-SomaFM && \
